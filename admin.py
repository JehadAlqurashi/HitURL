...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html']
    ...
    print("\x1b[32m// Example: https://www.google.com")
    url =  input("\x1b[32mEnter Site >>> ")
    lists = ['Navir.php','wso.php','Wso.php','c99','wso2018.php','alfa.php','1337w0rm.php','r57.php','1.php','2.php','3.php','4.php','Alfa.php','CGI.pl','K2ll33d','adminer.php','cwo.pl','3turr.php','Indoxploit.php','shell.php','Hack.php',"k2.php",'cmd.php','config.php','cgi.root']
    for i in lists:
        Nurl = url+"/"+i
        try:
